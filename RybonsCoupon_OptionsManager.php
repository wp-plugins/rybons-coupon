...
class RybonsCoupon_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'rybonscoupon'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'rybonscoupon'); ?></h2>
            <table class="form-table"><tbody>
                    <tr><td><?php _e('System', 'rybonscoupon'); ?></td><td><?php echo php_uname(); ?></td></tr>
                    <tr><td><?php _e('PHP Version', 'rybonscoupon'); ?></td>
                        <td><?php echo phpversion(); ?>
                            <?php
                            if (version_compare('5.2', phpversion()) > 0) {
                                echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                                _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'rybonscoupon');
                                echo '</span>';
                            }
                            ?>
                        </td>
                    </tr>
                    <tr><td><?php _e('MySQL Version', 'rybonscoupon'); ?></td>
                        <td><?php echo $this->getMySqlVersion() ?>
                            <?php
                            echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                            if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                                _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'rybonscoupon');
                            }
                            echo '</span>';
                            ?>
                        </td>
            ...
            <form method="post" action="">
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'rybonscoupon') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'rybonscoupon');
            case 'false':
                return __('false', 'rybonscoupon');

            case 'Administrator':
                return __('Administrator', 'rybonscoupon');
            case 'Editor':
                return __('Editor', 'rybonscoupon');
            case 'Author':
                return __('Author', 'rybonscoupon');
            case 'Contributor':
                return __('Contributor', 'rybonscoupon');
            case 'Subscriber':
                return __('Subscriber', 'rybonscoupon');
            case 'Anyone':
                return __('Anyone', 'rybonscoupon');
        }
        return $optionValue;
    }
